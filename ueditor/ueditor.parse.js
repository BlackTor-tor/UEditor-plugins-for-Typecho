  ...
  UE.parse.register("insertcode", function (utils) {
    ...
    if (pres.length) {
      if (typeof XRegExp == "undefined") {
        var jsurl, cssurl;
        // 获取代码主题配置，默认使用深色主题
        var codeTheme = window.UEDITOR_CODE_THEME || this.codeTheme || 'dark';
        var themeSuffix = (codeTheme === 'dark') ? 'Dark' : 'Default';
        ...
        if (this.rootPath !== undefined) {
          ...
          cssurl =
            utils.removeLastbs(this.rootPath) +
            "/third-party/SyntaxHighlighter/shCore" + themeSuffix + ".css";
        } else {
